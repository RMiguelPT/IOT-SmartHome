...
const char* mqtt_config_topic = "homeassistant/sensor/window/config";
const char* mqtt_state_topic = "homeassistant/sensor/window/state";
...
{
	if (client.connect("windowSensor", mqtt_user, mqtt_pass)) {
		Serial.println("MQTT_Connected");

		//******TEMPERATURE CONFIGURATION*******//
		JSONencoder["name"] = "Living Room Window State";
